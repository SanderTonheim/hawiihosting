...
export default function RightParagaph({ image, heading, text1, text2, list }) {
	...
	return (
		<div className='flex flex-col-reverse items-center max-w-full md:flex-row '>
			<div className='CONTENT max-w-3/4 mx-10 my-5 md:flex md:gap-10 '>
				...
				<Image
					src={image}
					className='max-w-[20rem] max-h-[20rem] m-auto'
				/>
			</div>
		</div>
	)
